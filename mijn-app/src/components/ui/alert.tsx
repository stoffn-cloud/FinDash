...
const AlertDialogAction = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action 
    ref={ref} 
    className={cn(buttonVariants({ variant: "default" }), "bg-blue-600 hover:bg-blue-500 text-white border-none", className)} 
    {...props} 
  />
))
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "mt-2 sm:mt-0 border-slate-700 bg-slate-800/50 text-slate-300 hover:bg-slate-800 hover:text-white", 
      className
    )}
    {...props} />
))
