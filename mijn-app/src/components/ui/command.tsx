...
// We voegen expliciet React.ComponentProps aan de types toe om children-errors te voorkomen
...
// Gebruik een interface die expliciet children toestaat
  ...
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-hidden p-0 bg-transparent border-none shadow-none max-w-2xl">
        {/* We gebruiken hier de basis CommandPrimitive direct om type-conflicten in de dialoog te vermijden */}
        <CommandPrimitive className={cn(
          "flex h-full w-full flex-col overflow-hidden rounded-2xl bg-slate-950/90 text-slate-200 backdrop-blur-xl border border-slate-800 shadow-2xl",
          "[&_[cmdk-group-heading]]:px-4 [&_[cmdk-group-heading]]:font-bold [&_[cmdk-group-heading]]:text-[10px] [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-[0.2em] [&_[cmdk-group-heading]]:text-slate-500 [&_[cmdk-group]]:px-2 [&_[cmdk-input]]:h-14 [&_[cmdk-item]]:px-4 [&_[cmdk-item]]:py-3 [&_[cmdk-item]]:rounded-xl"
        )}>
          {children}
        </CommandPrimitive>
      </DialogContent>
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      "overflow-hidden p-1 text-slate-400 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-slate-500",
      className
    )}
    {...props}
  />
